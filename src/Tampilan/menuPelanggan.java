 ...
 * @author Ozmond
 */
public class menuPelanggan extends javax.swing.JInternalFrame {
     ...
     */
    public menuPelanggan(DataPenjualan frame) {
        initComponents();
        tabel_pelanggan();
        this.f = frame;
    }
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addComponent(cariDataPelanggan, javax.swing.GroupLayout.PREFERRED_SIZE, 722, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tabel_pelangganMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabel_pelangganMouseClicked
        ...
        this.f.id_pelanggan.setText(tabel_pelanggan.getModel().getValueAt(baris, 0).toString());
        this.f.nama_pelanggan.setText(tabel_pelanggan.getModel().getValueAt(baris, 1).toString());
        this.f.alamat.setText(tabel_pelanggan.getModel().getValueAt(baris, 2).toString());
        this.f.no_telp.setText(tabel_pelanggan.getModel().getValueAt(baris, 3).toString());
    ...
    private void btnCariPelangganActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariPelangganActionPerformed
        ...
        setKoneksi();
        String sql="SELECT * FROM data_pelanggan WHERE id_pelanggan like '%" + cariDataPelanggan.getText() + "%'" 
                +"or nama_pelanggan like '%" + cariDataPelanggan.getText()+"%'";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            private DataPenjualan f;
            public void run() {
                new menuPelanggan(this.f).setVisible(true);
            }
        });
    }
